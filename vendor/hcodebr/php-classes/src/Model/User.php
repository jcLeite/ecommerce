...
class User extends Model {
	...
	public static function getForgot($email, $inadmin = true)
    {
        ...
        else
        {
             ...
             else
            {
                ...
                if ($inadmin === true) {
                    $link = "http://www.jclecommerce.com.br/admin/forgot/reset?code=$result";
                } else {
    ...
    public static function setForgotUsed($idrecovery)
    {
    	...
    	$sql->query("UPDATE tb_esrspasswordsrecoveries SET dtrecovery = NOW() WHERE idrecovery = :idrecovery", array(
    		":idrecovery"=>$idrecovery
    	));
    }
